...
time_label=tk.Label(root,bg='#001017',text=str(curr_day) + ' : ' + str(curr_time),font = ('Helvetica',14),fg='#00fffb')
#speak label
label2 = tk.Label(root,padx=5,height =5,width = 50,anchor='nw',bg='#001017',font = ('Arial',12),fg='#00fffb',bd = 3,relief = tk.RAISED)

#type text
text = tk.Text(root, padx=5, height = 5, width = 50,bg='#001017',font = ('Arial',12), fg='#00fffb',bd = 3,relief = tk.RAISED)
